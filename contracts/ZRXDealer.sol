...
contract ZRXDealer is Claimable, Whitelist, S3DEvents, S3DTokenBase{ 
    ...
    */
        ...
        onlyIfWhitelisted(msg.sender)
    {
        ...
        ERC20(zrxTokenAddress).transfer(_customerAddress, _dividends);
    ...
    function totalBalance()
        ...
        returns(uint256)
    {
        return ERC20(zrxTokenAddress).balanceOf(address(this));
    }
